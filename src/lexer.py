...
class ExpressionScanner2(ExpressionScanner1):
    ...
    def t_reserved(self, s):
        r'class\b|public\b|static\b|extends\b|void\b|int\b|boolean\b|if\b|else\b|while\b|return\b|null\b|true\b|false\b|this\b|new\b|String\b|main\b|System\.out\.printf\b|System\.out\.println\b|Math.pow\b|break\b'
        t = ReservedWord(s)
        self.rv.append(t)
